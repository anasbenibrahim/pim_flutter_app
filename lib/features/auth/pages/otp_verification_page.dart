                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Icon(Icons.security_rounded, color: Colors.white, size: 40.sp),
                        ),
                        SizedBox(height: 28.h),
                        Text('Code de vérification', style: TextStyle(fontSize: 26.sp, fontWeight: FontWeight.w800, color: Colors.white, letterSpacing: -0.5), textAlign: TextAlign.center),
